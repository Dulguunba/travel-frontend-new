...
const FrequentlyAsked = () => {
  return (
    <div className='w-full h-[700px] my-32 relative flex justify-center items-center'>
        ...
        <div className='w-[900px] h-full flex flex-col z-10'>
            <h1 className='w-full flex justify-center text-4xl font-bold mt-20 mb-5'>FREQUENTLY ASKED QUESTIONS</h1>
