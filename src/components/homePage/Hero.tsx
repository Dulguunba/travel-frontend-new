...
const Hero = () => {
  ...
  return (
    <div className='flex justify-center items-center w-full h-[900px] relative bg-[url("/heroPicture.jpg")] bg-center bg-origin-border bg-cover'>
        <Header/>
        <div className='w-full h-full flex flex-col items-center justify-center gap-10 '>
            <h1 className='text-white font-bold text-4xl'>UNFORGETABLE ADVENTURE</h1>
